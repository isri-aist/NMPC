...
TEST(TestDDPCentroidalMotion, SolveMpc)
{
  double dt = 0.03; // [sec]
...
TEST(TestDDPCentroidalMotion, CheckDerivative)
{
  ...
  DDPProblemCentroidalMotion::StateDimVector x = DDPProblemCentroidalMotion::StateDimVector::Random(state_dim);
  DDPProblemCentroidalMotion::InputDimVector u = DDPProblemCentroidalMotion::InputDimVector::Random(input_dim);
